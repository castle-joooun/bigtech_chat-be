"""
메시지 검색 모델 (Message Search Model) - 현재 미사용

================================================================================
아키텍처 개요 (Architecture Overview)
================================================================================
Elasticsearch/OpenSearch 도입을 위해 준비된 검색 인덱스 모델입니다.
...
인덱싱 전략:
    - content_normalized: 소문자 변환, 정규화된 검색 텍스트
    - content_keywords: 추출된 키워드 (NLP 처리)
    - search_priority: 메시지 타입별 가중치

권한 체계:
    - participants: 해당 메시지를 볼 수 있는 사용자 ID 목록
    - 검색 시 자동으로 권한 필터링
