"""
채팅방 API 엔드포인트 (Chat Room API Endpoints)

================================================================================
아키텍처 개요 (Architecture Overview)
================================================================================
채팅방 관리를 처리하는 FastAPI 라우터입니다.
1:1 채팅방의 조회 및 생성 기능을 제공합니다.
...
================================================================================
- GET /chat-rooms: 내 채팅방 목록 조회 (페이지네이션)
...
================================================================================
>>> # 채팅방 목록 조회 (페이지네이션)
>>> GET /chat-rooms?skip=0&limit=10
>>>
>>> # 특정 사용자와의 채팅방 조회/생성
>>> GET /chat-rooms/check/123
>>> # 기존 채팅방이 있으면 해당 채팅방, 없으면 새로 생성
"""
...
from legacy.app.schemas.chat_room import ChatRoomResponse
from legacy.app.api.auth import get_current_user
from legacy.app.core.errors import user_not_found_error, BusinessLogicException
from legacy.app.core.validators import Validator
from legacy.app.services import chat_room_service, auth_service
