"""
============================================================================
MVP에서 제외: WebSocket 방식 → SSE + Redis Pub/Sub 방식으로 전환
============================================================================

WebSocket 방식은 복잡성이 높고 연결 관리가 어려워
SSE(Server-Sent Events) + Redis Pub/Sub 방식으로 전환했습니다.

새로운 실시간 메시지 스트리밍:
- GET /messages/stream/{room_id} (app/api/message.py)

관련 파일들도 더 이상 사용하지 않음:
...
# WebSocket 엔드포인트는 모두 제거되었습니다.
# 실시간 메시지는 GET /messages/stream/{room_id}를 사용하세요.
